...
class StartedByTokenDto:
    ...
    token_type: Union[Unset, StartedByTokenDtoTokenType] = StartedByTokenDtoTokenType.AD_HOC_USER
    contract_id: Union[Unset, str] = UNSET
    auth_method: Union[Unset, StartedByTokenDtoAuthMethod] = StartedByTokenDtoAuthMethod.AUTH_REQUEST
