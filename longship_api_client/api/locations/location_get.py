...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v1/locations/{id}".format(client.base_url, id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[LocationDto, LongshipError]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[LocationDto, LongshipError]]:
    return Response(
