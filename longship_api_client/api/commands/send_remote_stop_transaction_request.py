...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: RemoteStopTransactionRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/remotestop".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a RemoteStopTransactionRequest.
     ...
     Sends a RemoteStopTransactionRequest command to the chargepoint.
