...
from ...models.update_firmware_request import UpdateFirmwareRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: UpdateFirmwareRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/updatefirmware".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a UpdateFirmwareRequest.

     Sends a UpdateFirmwareRequest command to the chargepoint.
