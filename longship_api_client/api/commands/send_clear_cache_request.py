...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ClearCacheRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/clearcache".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a ClearCacheRequest.

     Sends a ClearCacheRequest command to the chargepoint.
