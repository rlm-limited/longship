...
from ...models.cancel_reservation_request import CancelReservationRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: CancelReservationRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/cancelreservation".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a CancelReservationRequest.

     Sends a CancelReservationRequest command to the chargepoint.
