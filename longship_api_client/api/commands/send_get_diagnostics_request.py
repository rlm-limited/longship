...
from ...models.get_diagnostics_request import GetDiagnosticsRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: GetDiagnosticsRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/getdiagnostics".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a GetDiagnosticsRequest.

     Sends a GetDiagnosticsRequest command to the chargepoint.
