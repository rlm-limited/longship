...
from ...models.trigger_message_request import TriggerMessageRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: TriggerMessageRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/triggermessage".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a TriggerMessageRequest.

     Sends a TriggerMessageRequest command to the chargepoint.
