...
from ...models.unlock_connector_request import UnlockConnectorRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: UnlockConnectorRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/unlockconnector".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a UnlockConnectorRequest.

     Sends a UnlockConnectorRequest command to the chargepoint.
