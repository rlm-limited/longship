...
from ...models.get_local_list_version_request import GetLocalListVersionRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: GetLocalListVersionRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/getlocallistversion".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a GetLocalListVersionRequest.

     Sends a GetLocalListVersionRequest command to the chargepoint.
