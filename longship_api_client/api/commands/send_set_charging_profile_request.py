...
from ...models.set_charging_profile_request import SetChargingProfileRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: SetChargingProfileRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/setchargingprofile".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a SetChargingProfileRequest.

     Sends a SetChargingProfileRequest command to the chargepoint.
