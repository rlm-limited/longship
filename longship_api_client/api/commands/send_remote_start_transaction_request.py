...
from ...models.remote_start_transaction_request import RemoteStartTransactionRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: RemoteStartTransactionRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/remotestart".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a RemoteStartTransactionRequest.

     Sends a RemoteStartTransactionRequest command to the chargepoint.
