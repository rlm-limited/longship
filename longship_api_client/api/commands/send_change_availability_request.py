...
from ...models.change_availability_request import ChangeAvailabilityRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ChangeAvailabilityRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/changeavailability".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a ChangeAvailabilityRequest.

     Sends a ChangeAvailabilityRequest command to the chargepoint.
