...
from ...models.clear_charging_profile_request import ClearChargingProfileRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ClearChargingProfileRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/clearchargingprofile".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a ClearChargingProfileRequest.

     Sends a ClearChargingProfileRequest command to the chargepoint.
