...
from ...models.change_configuration_request import ChangeConfigurationRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: ChangeConfigurationRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/changeconfiguration".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a ChangeConfigurationRequest.

     Sends a ChangeConfigurationRequest command to the chargepoint.
