...
from ...models.send_local_list_request import SendLocalListRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: SendLocalListRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/sendlocallist".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a SendLocalListRequest.

     Sends a SendLocalListRequest command to the chargepoint.
