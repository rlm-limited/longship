...
from ...models.get_composite_schedule_request import GetCompositeScheduleRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: GetCompositeScheduleRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/getcompositeschedule".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a GetCompositeScheduleRequest.

     Sends a GetCompositeScheduleRequest command to the chargepoint.
