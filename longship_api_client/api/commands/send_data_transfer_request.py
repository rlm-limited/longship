...
from ...models.data_transfer_request import DataTransferRequest
...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: DataTransferRequest,
) -> Dict[str, Any]:
    url = "{}/v1/chargepoints/{id}/datatransfer".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Sends a DataTransferRequest.

     Sends a DataTransferRequest command to the chargepoint.
