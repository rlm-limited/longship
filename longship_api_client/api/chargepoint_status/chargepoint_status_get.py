...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v1/chargepoint/{id}/status".format(client.base_url, id=id)
...
) -> Optional[Union[ChargepointStatusDto, LongshipError]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[ChargepointStatusDto, LongshipError]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ChargepointStatusDto, LongshipError]
    """
