...
def _get_kwargs(
    ...
    *,
    client: Client,
    json_body: LocalTokenGroupTokenPostDto,
) -> Dict[str, Any]:
    url = "{}/v1/localtokengroups/{id}/token".format(client.base_url, id=id)
...
def sync_detailed(
    ...
    *,
    ...
    """Creates a localtokengrouptoken.

     Creates a new localtokengrouptoken.
