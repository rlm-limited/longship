...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v1/reimbursementcdrs/{id}".format(client.base_url, id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[LongshipError, ReimbursementCdrDto]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[LongshipError, ReimbursementCdrDto]]:
    return Response(
