...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/v1/tariffs/{id}".format(client.base_url, id=id)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[LongshipError, TariffDto]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[LongshipError, TariffDto]]:
    return Response(
