...
def _get_kwargs(
    *,
    ...
    order_by: Union[Unset, None, GetAllCdrsOrderBy] = GetAllCdrsOrderBy.STARTDATETIME,
    ...
    url = "{}/v1/cdrs".format(client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[List["CdrDto"], LongshipError]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[List["CdrDto"], LongshipError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order_by (Union[Unset, None, GetAllCdrsOrderBy]):  Default:
            GetAllCdrsOrderBy.STARTDATETIME.
