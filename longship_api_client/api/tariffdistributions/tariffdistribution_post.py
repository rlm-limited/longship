...
from ...models.tariff_distribution_post_dto import TariffDistributionPostDto
...
def _get_kwargs(
    *,
    client: Client,
    json_body: TariffDistributionPostDto,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Creates a tariffdistribution.

     Creates a new tariffdistribution.
