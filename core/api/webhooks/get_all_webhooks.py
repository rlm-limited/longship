...
def _get_kwargs(
    *,
    ...
    order_by: Union[Unset, GetAllWebhooksOrderBy] = GetAllWebhooksOrderBy.NAME,
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        ...
        for componentsschemaswebhook_summary_get_dto_array_item_data in _response_200:
            componentsschemaswebhook_summary_get_dto_array_item = (
                WebhookSummaryGetDto.from_dict(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order_by (Union[Unset, GetAllWebhooksOrderBy]):  Default: GetAllWebhooksOrderBy.NAME.
