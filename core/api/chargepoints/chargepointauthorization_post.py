...
from ...models.charge_point_authorize_post_dto import ChargePointAuthorizePostDto
...
def _get_kwargs(
    id: str,
    *,
    body: ChargePointAuthorizePostDto,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Creates a chargepointauthorization.

     Creates a new chargepointauthorization.
